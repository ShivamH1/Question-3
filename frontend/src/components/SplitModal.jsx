        ...
        <div className="modal-box max-w-2xl">
          ...
          <Formik
            ...
            onSubmit={async (values, { resetForm }) => {
              try {
                await axios.post("/api/v1/expenses/split-expense", {
          ...
          >
            <Form>
              <div className="form-control">
                ...
                <Field id="name" name="name" className="input input-bordered" />
                <ErrorMessage
                  name="name"
          ...
          <Formik
            ...
            validate={(values) => {
              ...
              if (!values.email) errors.email = "Required";
                ...
                if (
                  splitExpense.split.filter((spl) => spl.email === values.email)
                    .length > 0
                )
                  errors.email = "Already split with this user";
              }
            ...
            onSubmit={async (values, { resetForm }) => {
              try {
                const res = await axios.post("/api/v1/users/find-user", values);
                ...
                if (success) {
                  ...
                  showToastHandler("User does not exist", "error");
                  resetForm();
                }
              } catch (error) {
                showToastHandler("Split failed", "error");
